...
export const EXPANSION_START_COUNTDOWN = 15; // will try to expand to room with this score * EXPANSION_COUNTDOWN_SCORE, decreasing every expansionCheck run
export const EXPANSION_TICKS_LIMIT = 100_000; // if expansion don't finish in this time, stop it and considere a failure
export const ROOM_MAX_TICKS_IN_MEMORY = 50_000; // max ticks to keep room data in memory

export const MIN_SCAN_BUCKET_CPU = 1_000;
...
export const CONTROLLER_TICKS_TO_DOWNGRADE_EMERGENCY = 5_000;
